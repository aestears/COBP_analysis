#////////////////////
# Oenothera coloradensis Integral Projection Model
# Author: Alice Stears
...
### fecundity-- using size in current year (no. of seeds/plant, for those that flowered ~ size_t)
...
### fecundity--using size in previous year (no. of seeds/plant, for those that flowered ~ size_tminus1)
## visualize the data
...
### flowering probability--using size in current year
## visualize the data
...
### flowering probability--using size in previous year
## visualize the data
