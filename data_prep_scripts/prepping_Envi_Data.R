...
soilMoist <- read.csv("../Raw Data/EnviData/SoilMoisture.csv")
...
soilTemp <- read.csv("../Raw Data/EnviData/iButton Data/SoilTemp_allYear.csv")
...
#### load PRISM data ####
baseClim <- read.csv("../Raw Data/EnviData/FEWAB_PRISM_data.csv", skip = 10)
...
SoapClim <- read.csv("../Raw Data/EnviData/Soapstone_PRISM_data.csv", skip = 10)
