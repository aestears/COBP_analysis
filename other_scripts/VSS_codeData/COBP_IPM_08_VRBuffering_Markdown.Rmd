...
# growth
growth_OG <- h * t(outer(meshp,meshp,GR.fun, paramCont)) # don't multiply by h... so no integration? is this correct?
...
VSS.growth <- as.numeric(sens_Growth * ((growth.mean*(1-flowering.mu))/lambda_OG))
