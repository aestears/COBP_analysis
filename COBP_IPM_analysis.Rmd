...
These are the functions that describe each element of the IPM: 
...
**Seedbank (discrete stage):**  (after Ellner, 2016)
...
discreteDat <- read.csv("../Processed_Data/discreteStageData.csv")
```
